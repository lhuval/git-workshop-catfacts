sap.ui.core.mvc.Controller.extend("my_grants_v126.view.Master", {
	...
	loadDetailView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "my_grants_v126.view.Detail",
			targetViewType: "XML"
		});
	},
	...
	selectFirstItem: function() {
		...
		if (aItems.length) {
			...
			this.getRouter().myNavToWithoutHash({
				currentView: this.getView(),
				targetViewName: "my_grants_v126.view.NotFound",
				targetViewType: "XML"
			});
		}
	},
	...
	onSearch: function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [new sap.ui.model.Filter("GrantDesc", sap.ui.model.FilterOperator.Contains, searchString)];
		}
		// Update list binding
